...
Приложение для получения аниме с качественным видео и русскими озвучками:
...
## Нюансы
- Временная и итоговая папки пока не настраиваются и находятся в папке аппы, так что запускать ее лучше на SSD с хотя бы х2.5 свободного места от размера торрентов и озвучек
